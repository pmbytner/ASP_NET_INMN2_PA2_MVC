...
using ASP_NET_INMN2_PA2_MVC.Data;
...
namespace ASP_NET_INMN2_PA2_MVC.Controllers
{
    ...
    {
        private readonly INMN2_PA2_MVCContext _context;

        public MiastaController(INMN2_PA2_MVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nazwa,Powierzchnia,Populacja")] Miasto miasto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nazwa,Powierzchnia,Populacja")] Miasto miasto)
        {
            if (id != miasto.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            if (_context.Miasta == null)
            {
                return Problem("Entity set 'INMN2_PA2_MVCContext.Miasto'  is null.");
            }
            var miasto = await _context.Miasta.FindAsync(id);
            if (miasto != null)
            {
